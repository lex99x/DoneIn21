...
class Faq: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        questions = [
            QuestionDetail(question: "What is the 21 day theory?", titleQuestion: "What is the 21 day theory", answer: "Consistent joint movement can decrease the risk of injury in activities of daily living, and relieve pain from chronic conditions such as back pain or osteoarthritis. They influence both the mind and the body. A prolonged stretching routine can be an excellent method of relaxation and an excellent stress reducer.", backgroundColor: UIColor(named: "DoneIn21Blue")!, backgroundImage: UIImage(named: "oquee")!),
