...
class Check: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        cards = [
            CardDetail(exercisename: "Yoga", whatIs: "It is a safe and useful activity for everyone and can help improve general flexibility, neuromuscular coordination, balance and postural awareness.\n\nStretching performed with a volume of 30 to 60 seconds increases joint Range of Motion in most adults, being enough to improve flexibility", benefits: "Consistent joint movement can decrease the risk of injury in activities of daily living, and relieve pain from chronic conditions such as back pain or osteoarthritis.\n\nThey influence both the mind and the body. A prolonged stretching routine can be an excellent method of relaxation and an excellent stress reducer.", cardname: "Yoga",background: UIColor(named: "DoneIn21Blue")!,cardImage: UIImage(named: "yoga1x")!),
            CardDetail(exercisename: "Walk", whatIs: "e andar ora", benefits: "e muito bom pro", cardname: "andar",background: UIColor(named: "DoneIn21Orange")!,cardImage: UIImage(named: "andar1x")!),
            CardDetail(exercisename: "Pushups", whatIs: "description", benefits: "benefits a lot of the,", cardname: "Pushups", background: UIColor(named: "DoneIn21Blue")!, cardImage: UIImage(named: "flexao1x")!),
            CardDetail(exercisename: "Stretching", whatIs: "description", benefits: "benefits", cardname: "Stretching", background: UIColor(named: "DoneIn21Orange")!, cardImage: UIImage(named: "alongamento1x")!),
            CardDetail(exercisename: "Abs", whatIs: "Description", benefits: "benefits", cardname: "Abs", background: UIColor(named: "DoneIn21Blue")!, cardImage: UIImage(named: "abdominal1x")!)
